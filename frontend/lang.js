...
const LANG_STRINGS = {
  bm: {
    ...
    'login.logout': 'Keluar',
    'login.forgot.link': 'Lupa kata laluan?',
    'forgot.title': 'Lupa Kata Laluan',
    'forgot.hint': 'Masukkan alamat e-mel berdaftar anda. Kata laluan sementara akan dihantar ke e-mel tersebut.',
    'forgot.label': 'Emel',
    'forgot.cancel': 'Batal',
    'forgot.submit': 'Hantar Kata Laluan Sementara',
    'forgot.error.missing': 'Sila masukkan alamat e-mel anda.',
    'forgot.error.notfound': 'Emel ini tidak berdaftar dalam sistem. Sila hubungi pentadbir sistem.',
    'forgot.error.inactive': 'Akaun ini tidak aktif. Sila hubungi pentadbir sistem.',
    'forgot.error.network': 'Tidak dapat menyambung ke pelayan. Sila cuba lagi.',
    'forgot.success': 'Kata laluan sementara telah dihantar ke e-mel anda.',
  ...
  en: {
    ...
    'forgot.hint': 'Enter your registered email address. A temporary password will be sent to it.',
    'forgot.label': 'Email',
    'forgot.cancel': 'Cancel',
    'forgot.submit': 'Send Temporary Password',
    'forgot.error.missing': 'Please enter your email address.',
    'forgot.error.notfound': 'This email is not registered in the system. Please contact the system administrator.',
    'forgot.error.inactive': 'This account is inactive. Please contact the system administrator.',
    'forgot.error.network': 'Unable to reach the server. Please try again.',
    'forgot.success': 'A temporary password has been sent to your email.',
